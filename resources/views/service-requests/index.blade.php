<x-layouts.app title="Service Requests">
    <div id="service-requests-page" data-store-url="{{ route('service-requests.store') }}"
        ...
        <x-ui.page-header title="Service Requests"
            description="Submit and track service requests through HR/Admin fulfillment workflow.">
            <x-slot:actions>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-xl-3 col-sm-6">
                <x-ui.stat-card label="In Progress" value-id="summary-in-progress" value-class="text-warning" :loading="true"
                    border-tone="pending" icon-tone="warning">
        ...
        <x-ui.search-filters-panel id="service-requests-search-filters" title="Search & Filters"
            description="Search by service name, category, status, and requester.">
            <form id="service-requests-search-form" class="row g-3">
                ...
                @can('service-requests.manage')
                    <div class="col-xl-3 col-md-6">
                        <label for="filter-service-request-requester" class="form-label fw-bold text-dark">Requester</label>
                        <input type="text" id="filter-service-request-requester" name="search_requester" class="form-control"
        ...
        <x-ui.data-table-card title="Service Requests Table" class="mb-5"
                ...
                <table id="service-requests-table" class="table table-hover align-middle w-100">
                    <thead class="table-custom-header">
                        <tr>
                            ...
                            <th class="border-top-0">Requester</th>
