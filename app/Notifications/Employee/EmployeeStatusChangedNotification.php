...
class EmployeeStatusChangedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        $subject = __('Employee Status Updated: :name', ['name' => $this->employee->full_name]);

        return (new MailMessage)
            ->subject($subject)
            ->view('emails.notifications.employee-status-changed', [
                'subject' => $subject,
